...
var Render = {
  ...
  player: function(ctx, width, height, resolution, roadWidth, sprites, speedPercent, scale, destX, destY, steer, updown) {
    ...
    var sprW = (sprite.w * scale * width/2) * (SPRITES.SCALE * roadWidth);
    var sprH = (sprite.h * scale * width/2) * (SPRITES.SCALE * roadWidth);
    var foxX = destX + sprW * 0.13;
    var foxY = destY + bounce - sprH * 0.77;
    var foxSize = Math.max(12, Math.floor(sprH * 0.32));
    ctx.font = foxSize + 'px serif';
    ctx.textAlign = 'center';
    ctx.textBaseline = 'middle';
    ctx.fillText('🦊', foxX, foxY);

    var dogX = destX - sprW * 0.18;
    var dogY = destY + bounce - sprH * 0.78;
